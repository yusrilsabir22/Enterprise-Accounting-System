...
export class Initial1605544239430 implements MigrationInterface {
    name = 'Initial1605544239430'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_order" ("productId" character varying NOT NULL, "orderId" character varying NOT NULL, "count" integer NOT NULL, "price" integer NOT NULL, "total" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_33ff72639f1826668f8294a3e7d" PRIMARY KEY ("productId", "orderId"))`);
